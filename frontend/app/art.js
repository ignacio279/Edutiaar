...
// Separadas de app.js para poder testearlas en Node (node --test).

// Comillas simples en url(): los data-URI se inyectan dentro de atributos
// style="..." (comillas dobles); con dobles internas se cortaría el atributo.
export const uri = (s) => "url('data:image/svg+xml," + encodeURIComponent(s).replace(/'/g, '%27') + "')";
...
export const starBadge = () => uri(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40"><circle cx="20" cy="20" r="19" fill="#F4A93B" stroke="#FFFCF5" stroke-width="2"/><path d="M20 9 l3.2 6.6 7.2 1 -5.2 5 1.3 7.2 -6.5 -3.4 -6.5 3.4 1.3 -7.2 -5.2 -5 7.2 -1 z" fill="#FFFCF5"/></svg>`);
export const lockBadge = () => uri(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40"><circle cx="20" cy="20" r="19" fill="#C9BCA6" stroke="#FFFCF5" stroke-width="2"/><rect x="13" y="19" width="14" height="11" rx="3" fill="#FFFCF5"/><path d="M16 19 v-3 a4 4 0 0 1 8 0 v3" stroke="#FFFCF5" stroke-width="3" fill="none"/></svg>`);
