...
export function validarCrear(d: { nombre?: unknown; zona?: unknown; tipo?: unknown }): Resultado {
...
export function validarEditar(d: { nombre?: unknown; zona?: unknown; tipo?: unknown }): Resultado {
...
// Arma el patch de UPDATE a partir del body ya validado (trim; zona vacía → null).
export function armarPatchEditar(d: { nombre?: unknown; zona?: unknown; tipo?: unknown }): Record<string, unknown> {
