...
export function uiIcon(key: string) {
  const k: Record<string, string> = {
    ...
    moon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" fill="none" stroke="#7A6F5F" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"><path d="M62 18 A34 34 0 1 0 82 62 A28 28 0 1 1 62 18 Z"/><circle cx="76" cy="26" r="3" fill="#7A6F5F" stroke="none"/><circle cx="86" cy="40" r="2" fill="#7A6F5F" stroke="none"/></svg>`,
